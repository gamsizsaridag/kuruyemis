...
@section('modul')
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Marka</h4>
        </div>
...
@section('content')
    ...
    <form role="form" id="form" action="{{route('yonetim.brand.update',$brand->id)}}" method="post" enctype="multipart/form-data">
        @csrf

        <div class="form-group row">
            <label for="example-text-input" class="col-2 col-form-label">Kategori Adı*</label>
            <div class="col-5">
                <input class="form-control" name="name" required="" value="{{$brand->name}}" type="text" >
        ...
        <div class="form-group row">
            ...
            <div class="col-5">
                <input class="form-control" name="must" placeholder="1"  value="{{$brand->must}}" type="number" >
            </div>
        </div>
